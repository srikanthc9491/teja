...
def datae():
     ...
     return render_template("data.html", tables=[dfa_html, sale_html, Refund_html, Cancel_html, tab_html], titles = ['na', 'you have to file GSTR 1 for these states', 'Your successful orders', 'Your Refunds', 'Your Cancelled Order Data', 'Your B2B orders'], gstin=gstin, no_orders=no_orders, totalTax=totalTax, no_refunds=no_refunds, no_cancel=no_cancel, add=add, totalSale=totalSale)
